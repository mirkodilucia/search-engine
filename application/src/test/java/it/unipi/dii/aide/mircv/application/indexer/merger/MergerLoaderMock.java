...
public class MergerLoaderMock {
    ...
    public static MergerLoader load(Config config) {
        ...
        VocabularyEntry e = new VocabularyEntry("adam", 1, 0, 0, 1, 5, 4, 4);
        ...
        FileChannel[] documentsId = new FileChannel[2];
        documentsId[0] = null;
        documentsId[1] = null;

        FileChannel[] frequencyChannels = new FileChannel[2];
        frequencyChannels[0] = null;
        frequencyChannels[1] = null;

        return new MergerLoader(config, documentsId, frequencyChannels);
    }
}

...
public class UnaryCompressorTest {
    ...
    void integerArrayDecompression() {
        assertArrayEquals(new int[]{32}, UnaryCompressor.decode(new byte[]{(byte) 0b11111111, (byte) 0b11111111, (byte) 0b11111111, (byte) 0b11111110}, 1));
        assertArrayEquals(new int[]{3,5,11,1,6}, UnaryCompressor.decode(new byte[]{(byte) 0b11011110, (byte) 0b11111111, (byte) 0b11001111, (byte) 0b10000000}, 5));
        assertArrayEquals(new int[]{1,2,1,1,3}, UnaryCompressor.decode(new byte[]{(byte) 0b01000110}, 5));
    }
}
